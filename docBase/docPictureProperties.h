...
#define docPictureIsCropped(pip)                                        \
	((pip)->pipLeftCropTwips > 0 || (pip)->pipRightCropTwips > 0 || \
	 (pip)->pipTopCropTwips > 0 || (pip)->pipBottomCropTwips > 0)
...
int docUpdPictureProperties(PropertyMask *pDoneMask, PictureProperties *pipTo,
