...
{
	io->ioPixelsWide = COORDtoGRID(
		pixelsPerTwip, (io->ioScaleXUsed * io->ioTwipsWide) / 100);
	io->ioPixelsHigh = COORDtoGRID(
		pixelsPerTwip, (io->ioScaleYUsed * io->ioTwipsHigh) / 100);
