...
void docShapeArrowSizesTwips(DrawShapeArrow *dsa, int lineWidth, double xfac,
			     const Point2DD *shaft, const ShapeArrow *sa)
{
	double width;
	...
	geoRotationAffineTransform2DAtan(&at, shaft[1].y - shaft[0].y,
					 shaft[1].x - shaft[0].x);
