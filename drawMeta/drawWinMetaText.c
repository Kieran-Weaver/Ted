...
int appWinMetaReadUtf16Text(DeviceContext *dc, int expectChars,
...
static int appWinMetaProduceUtf8(void *voiddc, int produced, const char *bytes,
				 int count)
{
...
int appWinMetaReadLegacyText(DeviceContext *dc, int count, int expectBytes,
			     SimpleInputStream *sis)
{
	int rval = 0;
	int nbytes;
