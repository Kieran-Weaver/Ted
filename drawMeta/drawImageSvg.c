...
static int drawSvgStartImage(SvgWriter *sw, const DocumentRectangle *drDest)
{
...
int drawRasterImageSvg(SvgWriter *sw, const RasterImage *abiSrc,
		       ...
		       const DocumentRectangle *drDest)
{
	...
	sosBase64 = (SimpleOutputStream *)0;
	xmlPutString("\"", xw);
	xmlNewLine(xw);
...
int drawRasterImageSvgFromData(SvgWriter *sw, const char *contentType,
