...
#define AT2_X(x, y, at) ((at)->at2Axx * (x) + (at)->at2Ayx * (y) + (at)->at2Tx)
#define AT2_Y(x, y, at) ((at)->at2Axy * (x) + (at)->at2Ayy * (y) + (at)->at2Ty)

#define AT2_DET(at) ((at)->at2Axx * (at)->at2Ayy - (at)->at2Ayx * (at)->at2Axy)

#define AFF2DEB(af)                                                           \
	appDebug("%s(%3d) %s= [%g,%g,%g,%g + %g,%g]\n", __FILE__, __LINE__,   \
		 #af, (af)->at2Axx, (af)->at2Ayx, (af)->at2Axy, (af)->at2Ayy, \
		 (af)->at2Tx, (af)->at2Ty)
...
#define AT3_X(x, y, z, at)                                              \
	((at)->at3Axx * (x) + (at)->at3Ayx * (y) + (at)->at3Azx * (z) + \
	 (at)->at3Tx)
#define AT3_Y(x, y, z, at)                                              \
	((at)->at3Axy * (x) + (at)->at3Ayy * (y) + (at)->at3Azy * (z) + \
	 (at)->at3Ty)
#define AT3_Z(x, y, z, at)                                              \
	((at)->at3Axz * (x) + (at)->at3Ayz * (y) + (at)->at3Azz * (z) + \
	 (at)->at3Tz)
