...
int appUrlGetScheme(char *scheme, int schemeLen, const char *url)
{
	const char *s = url;
	int used;
	int made;
...
static int appUrlGetHost(int *pMade, char *host, int hostLen, const char *s,
			 int xterm)
{
	int used;
	int made;
...
int appUrlGetHttpHostPort(char *host, int hostLen, char *port, int portLen,
...
int appUrlGetFileHost(char *host, int hostLen, const char *schemeSpecific)
{
	const char *s = schemeSpecific;
	int used;
	int made;
