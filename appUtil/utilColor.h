...
#define LRGB8DEB(l, rgb8)                                                     \
	appDebug("%s(%3d) %s=%ld %s= RGBA:%d:%d:%d:%d\n", __FILE__, __LINE__, \
		 #l, ((long)l), #rgb8, (rgb8)->rgb8Red, (rgb8)->rgb8Green,    \
...
#define bmRGB8ColorsDiffer(a, b)                                             \
	((a)->rgb8Red != (b)->rgb8Red || (a)->rgb8Green != (b)->rgb8Green || \
	 (a)->rgb8Blue != (b)->rgb8Blue || (a)->rgb8Alpha != (b)->rgb8Alpha)
