...
int appColorRgb(APP_COLOR_RGB *xc, AppColors *acSys, unsigned int r,
...
int appColorNamed(APP_COLOR_RGB *xc, AppColors *acSys, const char *name)
{
	APP_COLOR_RGB exact;
...
static int appAllocateColors(AppColors *acSys)
{
	...
	case GDK_VISUAL_DIRECT_COLOR:
		...
		bmSetCalculatedShifts(ca, vis->red_mask, vis->green_mask,
				      vis->blue_mask);
...
int appColorFindRgb(APP_COLOR_RGB *xc, AppColors *acSys, unsigned int r,
		    unsigned int g, unsigned int b)
{
	ColorAllocator *ca = &(acSys->acAllocator);
