...
extern void *appMakeMetricRuler(int sizeAcross, double magnifiedPixelsPerTwip,
...
extern void appHorizontalRulerTrackMouse(int *pX0pixels, int *pX1pixels,
					 int *pChanged, APP_WIDGET w,
					 EditApplication *ea,
					 APP_EVENT *downEvent, void *voidmr,
					 EditDocument *ed);

extern void appVerticalRulerTrackMouse(int *pY0pixels, int *pY1pixels,
				       int *pChanged, APP_WIDGET w,
				       EditApplication *ea,
				       APP_EVENT *downEvent, void *voidmr,
				       EditDocument *ed);

extern void appScrollHorMetricRuler(void *voidmr, APP_WIDGET w, int d);

extern void appScrollVertMetricRuler(void *voidmr, APP_WIDGET w, int d);

extern void appSetMetricRulerRange(void *voidmr, APP_WIDGET w, int docFullV1,
				   int docVisV0, int docVisV1);

extern void appSetMetricRulerValues(APP_WIDGET w, void *voidmr, int v0, int v1);

extern void appSetMetricRulerMagnification(APP_WIDGET w, void *voidmr,
					   double magnifiedPixelsPerTwip,
					   double magnification);

extern void appAdaptMetricRuler(APP_WIDGET w, void *voidmr, int documentC1);

extern void appDocSetMetricTopRuler(EditDocument *ed, int topRulerHeight,
				    double magnification, int unitInt,
				    APP_EVENT_HANDLER_T mouseDown);

extern void appDocSetMetricLeftRuler(EditDocument *ed, int topRulerHeight,
				     double magnification, int unitInt,
				     APP_EVENT_HANDLER_T mouseDown);
...
extern void appRemoveRectangleSelection(const DocumentRectangle *drVisible,
					DocumentRectangle *drSelected,
					APP_WIDGET w);
...
extern void appMetricRulerChangeValue(EditDocument *ed, int newValue);

extern void appHorizontalRulerDrawMark(RulerData *rd, int fontBottom, int tagY0,
