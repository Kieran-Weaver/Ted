...
typedef void (*APP_GIVE_COPY)(Widget w, void *through, APP_SELECTION_EVENT *e,
			      Boolean *pRefused);

typedef void (*APP_PASTE_REPLY)(Widget w, void *through, APP_SELECTION_EVENT *e,
				Boolean *pRefused);

#define APP_GIVE_COPY(n, w, e, t) \
	void n(Widget w, void *t, APP_SELECTION_EVENT *e, Boolean *pRefused)

#define APP_PASTE_REPLY(n, w, e, t) \
	void n(Widget w, void *t, APP_SELECTION_EVENT *e, Boolean *pRefused)

/****/
#define APP_TOGGLE_CALLBACK_H(n, w, t, e) void n(Widget w, void *t, void *e)

typedef APP_TOGGLE_CALLBACK_H((*APP_TOGGLE_CALLBACK_T), w, t, e);

/****/
#define APP_SCROLLBAR_CALLBACK_H(n, w, t, e) void n(Widget w, void *t, void *e)

typedef APP_SCROLLBAR_CALLBACK_H((*APP_SCROLLBAR_CALLBACK_T), w, t, e);

/****/
#define APP_SLIDER_CALLBACK_H(n, w, t, e) void n(Widget w, void *t, void *e)

typedef APP_SLIDER_CALLBACK_H((*APP_SLIDER_CALLBACK_T), w, t, e);

/****/
#define APP_MENU_CALLBACK_H(n, w, t, e) void n(Widget w, void *t, void *e)
...
/****/
#define APP_BUTTON_CALLBACK_H(n, w, t) void n(Widget w, void *t, void *pbcs)

typedef APP_BUTTON_CALLBACK_H((*APP_BUTTON_CALLBACK_T), w, t);

/****/
#define APP_EVENT_HANDLER_H(n, w, t, e) \
	void n(Widget w, void *t, XEvent *e, Boolean *pRefused)

typedef APP_EVENT_HANDLER_H((*APP_EVENT_HANDLER_T), w, t, e);

/****/
#define APP_CLOSE_CALLBACK_H(n, w, t) void n(Widget w, void *t, void *e)

typedef APP_CLOSE_CALLBACK_H((*APP_CLOSE_CALLBACK_T), w, t);

/****/
#define APP_TXTYPING_CALLBACK_H(n, w, t) void n(Widget w, void *t, void *e)

typedef APP_TXTYPING_CALLBACK_H((*APP_TXTYPING_CALLBACK_T), w, t);

/****/
#define APP_TXACTIVATE_CALLBACK_H(n, w, t) void n(Widget w, void *t, void *e)
...
#define APP_LIST_CALLBACK_H(n, w, t, c) \
	void n(Widget w, void *t, APP_LIST_CHOICE *c)

typedef APP_LIST_CALLBACK_H((*APP_LIST_CALLBACK_T), w, t, c);

/****/
#define APP_DESTROY_CALLBACK_H(n, w, t) void n(Widget w, void *t, void *e)

typedef APP_DESTROY_CALLBACK_H((*APP_DESTROY_CALLBACK_T), w, t);

/****/

#define APP_TIMER_HANDLER(n, d) void n(void *d, XtIntervalId *xii)
...
extern void appFinishOptionmenuMotif(APP_WIDGET menu, APP_WIDGET pulldown);

extern void appGuiMotifSetFocusToWindow(APP_WIDGET w);

extern void appGuiMotifWaitForWindow(APP_WIDGET shell, XtAppContext context);
