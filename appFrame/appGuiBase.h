...
/************************************************************************/
/*									*/
/*  GTK definitions for appGuiBase.h.					*/
/*									*/
/************************************************************************/
...
typedef void (*APP_GIVE_COPY)(GtkWidget *w, APP_SELECTION_EVENT *event,
			      guint info, guint tim, void *through);

typedef void (*APP_PASTE_REPLY)(GtkWidget *w, APP_SELECTION_EVENT *gsd,
				guint tim, void *voided);

#define APP_GIVE_COPY(n, w, e, t)                                           \
	void n(GtkWidget *w, APP_SELECTION_EVENT *e, guint info, guint tim, \
	       void *t)

#define APP_PASTE_REPLY(n, w, e, t) \
	void n(GtkWidget *w, APP_SELECTION_EVENT *e, guint tim, void *t)

/****/
#define APP_TOGGLE_CALLBACK_H(n, w, t, e) void n(GtkWidget *w, void *t)

typedef APP_TOGGLE_CALLBACK_H((*APP_TOGGLE_CALLBACK_T), w, t, e);

/****/
#define APP_SCROLLBAR_CALLBACK_H(n, w, t, e) void n(GtkWidget *w, void *t)

typedef APP_SCROLLBAR_CALLBACK_H((*APP_SCROLLBAR_CALLBACK_T), w, t, e);

/****/
#define APP_SLIDER_CALLBACK_H(n, w, t, e) void n(GtkWidget *w, void *t)

typedef APP_SLIDER_CALLBACK_H((*APP_SLIDER_CALLBACK_T), w, t, e);

/****/
#define APP_MENU_CALLBACK_H(n, w, t, e) void n(GtkWidget *w, void *t)
...
#define APP_EVENT_HANDLER_H(n, w, t, e) \
	void n(GtkWidget *w, GdkEvent *e, void *t)

typedef APP_EVENT_HANDLER_H((*APP_EVENT_HANDLER_T), w, t, e);

/****/
#define APP_CLOSE_CALLBACK_H(n, w, t) void n(GtkWidget *w, GdkEvent *e, void *t)

typedef APP_CLOSE_CALLBACK_H((*APP_CLOSE_CALLBACK_T), w, t);

/****/
#define APP_TXTYPING_CALLBACK_H(n, w, t) void n(GtkWidget *w, void *t)

typedef APP_TXTYPING_CALLBACK_H((*APP_TXTYPING_CALLBACK_T), w, t);

/****/
#define APP_TXACTIVATE_CALLBACK_H(n, w, t) void n(GtkWidget *w, void *t)
...
#define APP_LIST_CALLBACK_H(n, w, t, c) \
	void n(GtkWidget *w, APP_LIST_CHOICE *c, void *t)
...
#else
#define APP_DESTROY_CALLBACK_H(n, w, t) void n(GtkWidget *w, void *t)

typedef APP_DESTROY_CALLBACK_H((*APP_DESTROY_CALLBACK_T), w, t);
#endif

/****/
#define APP_TIMER_HANDLER(n, d) int n(void *d)
