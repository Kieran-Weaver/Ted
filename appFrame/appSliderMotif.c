...
{
	XtVaSetValues(slider, XmNminimum, minVal, XmNmaximum, maxVal, XmNvalue,
		      curVal, NULL);
}

void appGuiSetSliderValue(APP_WIDGET slider, int curVal)
{
	XtVaSetValues(slider, XmNvalue, curVal, NULL);
}

int appGuiGetValueFromSliderCallback(int *pValue, APP_WIDGET w, void *e)
{
