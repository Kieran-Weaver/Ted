			   ...
			   APP_BUTTON_CALLBACK_T rightCallback, void *through)
{
	...
	appMakeButtonInRow(&rightButton, row, rightLabel, rightCallback,
			   through, 1, colspan, showAsDefault);
			   ...
			   APP_BUTTON_CALLBACK_T rightCallback, void *through)
{
	...
	appMakeButtonInRow(&leftButton, row, leftLabel, leftCallback, through,
			   0, colspan, showAsDefault);
	appMakeButtonInRow(&middleButton, row, middleLabel, middleCallback,
			   through, 1, colspan, showAsDefault);
	appMakeButtonInRow(&rightButton, row, rightLabel, rightCallback,
			   through, 2, colspan, showAsDefault);
...
void guiToolMake3ToggleRow(APP_WIDGET *pRow, APP_WIDGET parent,
			   APP_WIDGET *pLeftToggle, APP_WIDGET *pMiddleToggle,
			   ...
			   APP_TOGGLE_CALLBACK_T rightCallback, void *through)
{
	...
	leftToggle = appMakeToggleInRow(row, leftText, leftCallback, through,
					leftColumn, 1);
	middleToggle = appMakeToggleInRow(row, middleText, middleCallback,
					  through, middleColumn, 1);
	rightToggle = appMakeToggleInRow(row, rightText, rightCallback, through,
					 rightColumn, 1);
	*pRow = row;
	*pLeftToggle = leftToggle;
				...
				OptionmenuCallback callBack, void *target)
{
	...
	/**************/
	appMakeOptionmenuInRow(aom, row, menuColumn, menuColspan, callBack,
			       target);
...
void guiToolMakeLabelAndTextRow(APP_WIDGET *pRow, APP_WIDGET *pLabel,
				APP_WIDGET *pText, APP_WIDGET column,
