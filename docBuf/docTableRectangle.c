			       ...
			       const TableRectangle *tr2)
{
	...
	if (tr1->trRow00 != tr2->trRow00) {
		LLDEB(tr1->trRow00, tr2->trRow00);
		return 0;
	}
	if (tr1->trRow11 != tr2->trRow11) {
		LLDEB(tr1->trRow11, tr2->trRow11);
		return 0;
	}
	if (tr1->trCol11 != tr2->trCol11) {
		LLDEB(tr1->trCol11, tr2->trCol11);
		return 0;
	}
...
void docExpandTableRectangleToWholeRows(TableRectangle *tr)
{
	...
	if (tr->trRow0 != tr->trRow1 || tr->trCol0 != tr->trCol1) {
		tr->trCellRowspan = 0;
		tr->trCellColspan = 0;
	}
