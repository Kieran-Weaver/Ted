...
extern void bmFreeGroups(void **groups, int numberOfGroups);
...
typedef int (*BM_PIX_FUN)(void *through, int row, int col);

typedef void (*BM_SEG_FUN)(void *through, int x0, int y0, int x1, int y1);

typedef int (*RasterTransformation)(RasterImage *riOut, const RasterImage *riIn,
				    int option);

extern int bmWhiteToTransparent(RasterImage *riOut, const RasterImage *riIn,
				int ignoredInt);

extern int bmVerticalFlip(RasterImage *riOut, const RasterImage *riIn,
			  int ignoredInt);

extern int bmHorizontalFlip(RasterImage *riOut, const RasterImage *riIn,
			    int ignoredInt);

extern int bmRotate180(RasterImage *riOut, const RasterImage *riIn,
		       int ignoredInt);

extern int bmRotate90(RasterImage *riOut, const RasterImage *riIn,
		      int ignoredInt);

extern int bmColorReduce(RasterImage *riOut, const RasterImage *riIn,
			 int colorCount);

extern int bmRotate(RasterImage *riOut, const RasterImage *riIn, double angle);

extern int bmFilterSobel(RasterImage *riOut, const RasterImage *riIn,
			 int ignoredInt);

extern int bmFilterLaplace(RasterImage *riOut, const RasterImage *riIn,
			   int ignoredInt);

extern int bmFilterSmoothe(RasterImage *riOut, const RasterImage *riIn,
			   int ignoredInt);

extern int bmFilterBlur(RasterImage *riOut, const RasterImage *riIn,
			int ignoredInt);

extern int bmFilterRelative(RasterImage *riOut, const RasterImage *riIn,
			    int ignoredInt);

extern int bmFlipBytes(unsigned char *buffer, int byteCount, int bitsPerPixel);

int bmMapImageColors(const BitmapDescription *bd, const int *map,
		     unsigned char *buffer);

extern int bmAverage(RasterImage *riOut, const RasterImage *riIn, int xpixels,
		     int ypixels);

extern int bmExpandPaletteImage(RasterImage *riOut, const RasterImage *riIn,
				int ignoredInt);

extern int bmTransparentImage(BitmapDescription *bdOut, unsigned char **pBufOut,
			      int colorEncoding, int wide, int high);

extern int bmRGBImage(BitmapDescription *bdOut, unsigned char **pBufOut,
		      int colorEncoding, int r, int g, int b, int wide,
		      int high);

extern int bmGammaCorrect(RasterImage *riOut, const RasterImage *riIn,
			  double gammaValue);

extern int bmInvertImage(RasterImage *riOut, const RasterImage *riIn,
			 int ignoredInt);
...
extern int bmToGrayscale(RasterImage *riOut, const RasterImage *riIn,
			 int ignoredInt);

extern int bmToWebSafe(RasterImage *riOut, const RasterImage *riIn,
		       int ignoredInt);

extern int bmThreshold(RasterImage *riOut, const RasterImage *riIn,
		       int ignoredInt);

extern int bmMorphoDilateSimple(RasterImage *riOut, const RasterImage *riIn,
				int ignoredInt);

extern int bmMorphoErodeSimple(RasterImage *riOut, const RasterImage *riIn,
			       int ignoredInt);

extern int bmMorphoDilate(RasterImage *riOut, const RasterImage *riIn,
			  const RasterImage *riSe, int rowOrig, int colOrig);

extern int bmMorphoErode(RasterImage *riOut, const RasterImage *riIn,
			 const RasterImage *riSe, int rowOrig, int colOrig);

extern int bmMorphoSetSimpleSe(RasterImage *riOut);

extern int bmMorphoLineElement(RasterImage *riOut, int wide, int high, int x0,
			       int y0, int x1, int y1);

extern void bmDraw1BitImage(const BitmapDescription *bdTo, unsigned char *bufTo,
			    const RasterImage *riIn, unsigned char invertMaskIn,
			    int rowTo0, int colTo0);

extern int bmForAll1Pixels(const RasterImage *riIn, unsigned char invertMaskIn,
			   void *through, BM_PIX_FUN pixFun);

extern int bmFindLineSegments(const RasterImage *riIn, int size, void *through,
			      BM_SEG_FUN segFun);

extern int bmCountLinePixels(const unsigned char *buffer,
			     const BitmapDescription *bd, int x0, int y0,
			     int x1, int y1);

extern int bmDrawLine(unsigned char *buffer, const BitmapDescription *bd,
		      int x0, int y0, int x1, int y1, int wide);

extern int bmDrawBox(unsigned char *buffer, const BitmapDescription *bd, int x0,
		     int y0, int x1, int y1, int wide);
...
extern int bmCopyArea(int up, int vp, RasterImage *riTo,
		      const RasterImage *riFrom);

extern int bmPaintArea(int up, int vp, RasterImage *riTo,
		       const RasterImage *riFrom);

extern int bmGetAlphaMask(RasterImage *riOut, const RasterImage *riIn,
			  int ignoredInt);

extern int bmRemoveAlpha(RasterImage *riOut, const RasterImage *riIn,
			 int ignoredInt);

extern int
bmSetAlphaMask(BitmapDescription *bdOut, const BitmapDescription *bdImage,
	       const BitmapDescription *bdAlpha, unsigned char **pBufOut,
	       const unsigned char *bufImage, const unsigned char *bufAlpha);
