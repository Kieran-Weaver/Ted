...
#define ISO1_isalnum(c) \
	(ISO1_isupper((c)) || ISO1_islower((c)) || ISO1_isdigit((c)))
#define ISO1_tolower(c) \
	(((ISO1_isupper(c) && (c) != ISO1_germandbls)) ? ((c) + 0x20) : (c))
#define ISO1_toupper(c) \
	(((ISO1_islower(c) && (c) != ISO1_germandbls)) ? ((c)-0x20) : (c))
...
#define ISO15_isupper(c)                                   \
	((ASCII_isupper((c))) ||                           \
	 ((c) >= ISO1_Agrave && (c) <= ISO1_Odieresis) ||  \
	 ((c) >= ISO1_Oslash && (c) <= ISO1_germandbls) || \
	 ((c) == ISO15_Scaron) || ((c) == ISO15_Zcaron) || \
	 ((c) == ISO15_OE) || ((c) == ISO15_Ydieresis))
#define ISO15_islower(c)                                      \
	((ASCII_islower((c))) ||                              \
	 ((c) >= ISO1_germandbls && (c) <= ISO1_odieresis) || \
	 ((c) >= ISO1_oslash && (c) <= ISO1_ydieresis) ||     \
	 ((c) == ISO15_scaron) || ((c) == ISO15_zcaron) || ((c) == ISO15_oe))

#define ISO15_isalpha(c) (ISO15_isupper((c)) || ISO15_islower((c)))
#define ISO15_isdigit(c) (ASCII_isdigit((c)))
#define ISO15_isalnum(c) \
	(ISO15_isupper((c)) || ISO15_islower((c)) || ISO15_isdigit((c)))

#define ISO15_tolower(c)                                                          \
	((!ISO15_isupper(c) ?                                                     \
		  (c) :                                                           \
		  ((c) == ISO1_germandbls ?                                       \
			   (ISO1_germandbls) :                                    \
...
#define ISO2_isupper(c)                                    \
	((ASCII_isupper((c))) || ((c) == ISO2_Aogonek) ||  \
	 ((c) == ISO2_Lslash) || ((c) == ISO2_Lcaron) ||   \
	 ((c) == ISO2_Sacute) || ((c) == ISO2_Scaron) ||   \
	 ((c) == ISO2_Scedilla) || ((c) == ISO2_Tcaron) || \
	 ((c) == ISO2_Zacute) || ((c) == ISO2_Zcaron) ||   \
	 ((c) == ISO2_Zdotaccent) ||                       \
	 ((c) >= ISO2_Racute && (c) <= ISO2_Odieresis) ||  \
	 ((c) >= ISO2_Rcaron && (c) <= ISO2_germandbls))

#define ISO2_islower(c)                                       \
	((ASCII_islower((c))) || ((c) == ISO2_aogonek) ||     \
	 ((c) == ISO2_lslash) || ((c) == ISO2_lcaron) ||      \
	 ((c) == ISO2_sacute) || ((c) == ISO2_scaron) ||      \
	 ((c) == ISO2_scedilla) || ((c) == ISO2_tcaron) ||    \
	 ((c) == ISO2_zacute) || ((c) == ISO2_zcaron) ||      \
...
#define ISO2_isalnum(c) \
	(ISO2_isupper((c)) || ISO2_islower((c)) || ISO2_isdigit((c)))
#define ISO2_tolower(c)                                          \
	(((ISO2_isupper(c) && (c) != ISO2_germandbls)) ?         \
		 (((c) >= 0xa0 && (c) <= 0xaf) ? ((c) + 0x10) :  \
						 ((c) + 0x20)) : \
		 (c))
#define ISO2_toupper(c)                                                     \
	(((ISO2_islower(c) && (c) != ISO2_germandbls)) ?                    \
		 (((c) >= 0xb0 && (c) <= 0xbf) ? ((c)-0x10) : ((c)-0x20)) : \
		 (c))
...
#define ISO7_isupper(c)                                            \
	((ASCII_isupper((c))) || ((c) == ISO7_Alphatonos) ||       \
	 ((c) == ISO7_Epsilontonos) || ((c) == ISO7_Etatonos) ||   \
	 ((c) == ISO7_Iotatonos) || ((c) == ISO7_Omicrontonos) ||  \
	 ((c) == ISO7_Upsilontonos) || ((c) == ISO7_Omegatonos) || \
	 ((c) >= ISO7_Alpha && (c) <= ISO7_Rho) ||                 \
	 ((c) >= ISO7_Sigma && (c) <= ISO7_Upsilondieresis))

#define ISO7_islower(c)          \
	((ASCII_islower((c))) || \
...
#define ISO7_isalnum(c) \
	(ISO7_isupper((c)) || ISO7_islower((c)) || ISO7_isdigit((c)))
...
#define PSSYM_isalpha(c) (PSSYM_isupper((c)) || PSSYM_islower((c)))

#define PSSYM_isdigit(c) (ASCII_isdigit((c)))

#define PSSYM_isalnum(c) \
	(PSSYM_isupper((c)) || PSSYM_islower((c)) || PSSYM_isdigit((c)))

#define PSSYM_isupper(c)                                 \
	(((c) >= PSSYM_Alpha && (c) <= PSSYM_Iota) ||    \
	 ((c) >= PSSYM_Kappa && (c) <= PSSYM_Upsilon) || \
	 ((c) >= PSSYM_Omega && (c) <= PSSYM_Zeta) || ((c) == PSSYM_Upsilon1))

#define PSSYM_islower(c)                                                       \
	(((c) >= PSSYM_alpha && (c) <= PSSYM_zeta) || ((c) == PSSYM_theta1) || \
	 ((c) == PSSYM_sigma1))
...
#define ISO5_isalnum(c) \
	(ISO5_isupper((c)) || ISO5_islower((c)) || ISO5_isdigit((c)))
...
#define KOI8R_isupper(c)                                   \
	((ASCII_isupper((c))) || (c) == KOI8R_afii10023 || \
	 ((c) >= KOI8R_afii10048 && (c) <= KOI8R_afii10044))
#define KOI8R_islower(c)                                   \
	((ASCII_islower((c))) || (c) == KOI8R_afii10071 || \
	 ((c) >= KOI8R_afii10096 && (c) <= KOI8R_afii10092))
#define KOI8R_isalpha(c) (KOI8R_isupper((c)) || KOI8R_islower((c)))
#define KOI8R_isdigit(c) (ASCII_isdigit((c)))
#define KOI8R_isalnum(c) \
	(KOI8R_isupper((c)) || KOI8R_islower((c)) || KOI8R_isdigit((c)))

#define KOI8R_tolower(c)                                               \
	(((ASCII_isupper(c))) ? ((c) + 0x20) :                         \
				((c) == KOI8R_afii10023 ? ((c)-0x10) : \
				 KOI8R_isupper(c)	? ((c)-0x20) : \
							  (c)))

#define KOI8R_toupper(c)                                                 \
	(((ASCII_islower(c))) ? ((c)-0x20) :                             \
				((c) == KOI8R_afii10071 ? ((c) + 0x10) : \
				 KOI8R_islower(c)	? ((c) + 0x20) : \
							  (c)))
...
#define ISO9_isalnum(c) \
	(ISO9_isupper((c)) || ISO9_islower((c)) || ISO9_isdigit((c)))

#define ISO9_tolower(c)                                 \
	(((ISO9_isupper(c) && (c) != ISO9_germandbls && \
	   (c) != ISO9_Idotaccent)) ?                   \
		 ((c) + 0x20) :                         \
...
#define ISO13_isupper(c)                                     \
	((ASCII_isupper((c))) || ((c) == ISO13_Oslash) ||    \
	 ((c) == ISO13_Rcommaaccent) || ((c) == ISO13_AE) || \
	 ((c) >= ISO13_Aogonek && (c) <= ISO13_Odieresis) || \
	 ((c) >= ISO13_Uogonek && (c) <= ISO13_germandbls))

#define ISO13_islower(c)                                        \
	((ASCII_islower((c))) || ((c) == ISO13_oslash) ||       \
	 ((c) == ISO13_rcommaaccent) || ((c) == ISO13_ae) ||    \
	 ((c) >= ISO13_germandbls && (c) <= ISO13_odieresis) || \
	 ((c) >= ISO13_Uogonek && (c) <= ISO13_zcaron))

#define ISO13_isalpha(c) (ISO13_isupper((c)) || ISO13_islower((c)))

#define ISO13_isdigit(c) (ASCII_isdigit((c)))
...
#define ISO13_tolower(c)                                                      \
	(ASCII_islower(c) ?                                                   \
		 ASCII_tolower(c) :                                           \
		 (((c) == ISO13_Oslash || (c) == ISO13_Rcommaaccent ||        \
		   (c) == ISO13_AE) ?                                         \
			  ((c) + 0x10) :                                      \
			  (((c) >= ISO13_Aogonek && (c) <= ISO13_Odieresis) ? \
				   ((c) + 0x20) :                             \
