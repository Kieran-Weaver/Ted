...
static RtfControlWord docRtfShapePropertyWords[] = {
	...
	SHAPE_LINE_NUMBER("lineStartArrowLength",
	...
	SHAPE_LOCK_NUMBER("fLockAgainstGrouping",
	...
	SHAPE_SHADOW_NUMBER("shadowSecondOffsetX",
			    DSHPprop_shadowSecondOffsetX),
	SHAPE_SHADOW_NUMBER("shadowSecondOffsetY",
	...
	SHAPE_NUMBER("dxyCalloutDropSpecified",
		     DSHPprop_dxyCalloutDropSpecified),
	SHAPE_NUMBER("dxyCalloutLengthSpecified",
	...
	SHAPE_NUMBER("fCalloutLengthSpecified",
	...
	SHAPE_NUMBER("lineBottomBackColorExtCMY",
		     DSHPprop_lineBottomBackColorExtCMY),
	SHAPE_NUMBER("lineBottomBackColorExtK",
		     DSHPprop_lineBottomBackColorExtK),
	SHAPE_NUMBER("lineBottomBackColorExtMod",
	...
	SHAPE_NUMBER("lineBottomEndArrowLength",
		     DSHPprop_lineBottomEndArrowLength),
	SHAPE_NUMBER("lineBottomEndArrowWidth",
	...
	SHAPE_NUMBER("lineBottomFillBlipFlags",
	...
	SHAPE_NUMBER("lineBottomStartArrowLength",
		     DSHPprop_lineBottomStartArrowLength),
	SHAPE_NUMBER("lineBottomStartArrowWidth",
		     DSHPprop_lineBottomStartArrowWidth),
	SHAPE_NUMBER("lineBottomStartArrowhead",
	...
	SHAPE_NUMBER("lineColumnBackColorExtCMY",
		     DSHPprop_lineColumnBackColorExtCMY),
	SHAPE_NUMBER("lineColumnBackColorExtK",
		     DSHPprop_lineColumnBackColorExtK),
	SHAPE_NUMBER("lineColumnBackColorExtMod",
	...
	SHAPE_NUMBER("lineColumnEndArrowLength",
		     DSHPprop_lineColumnEndArrowLength),
	SHAPE_NUMBER("lineColumnEndArrowWidth",
	...
	SHAPE_NUMBER("lineColumnFillBlipFlags",
	...
	SHAPE_NUMBER("lineColumnStartArrowLength",
		     DSHPprop_lineColumnStartArrowLength),
	SHAPE_NUMBER("lineColumnStartArrowWidth",
		     DSHPprop_lineColumnStartArrowWidth),
	SHAPE_NUMBER("lineColumnStartArrowhead",
	...
	SHAPE_NUMBER("lineLeftStartArrowLength",
		     DSHPprop_lineLeftStartArrowLength),
	SHAPE_NUMBER("lineLeftStartArrowWidth",
	...
	SHAPE_NUMBER("lineRightEndArrowLength",
	...
	SHAPE_NUMBER("lineRightStartArrowLength",
		     DSHPprop_lineRightStartArrowLength),
	SHAPE_NUMBER("lineRightStartArrowWidth",
		     DSHPprop_lineRightStartArrowWidth),
	SHAPE_NUMBER("lineRightStartArrowhead",
	...
	SHAPE_NUMBER("lineTopStartArrowLength",
...
static int docRtfMakeShapePropHash(void)
{
	...
	for (i = 0; i < keyStringCount; i++) {
		keyStrings[i] =
			(const unsigned char *)docRtfShapePropertyWords[i]
				.rcwWord;
	}

	if (utilJenkinsPerfectHash(keyStrings, keyStringCount,
				   "docRtfShapePropHash.c",
				   "\"docRtfTagHash.h\"", "docRtfShapePropHash",
...
static int docRtfCheckShapePropHash(void)
{
	...
	for (i = 0; i < keyStringCount; i++) {
		...
		tagkey = (const unsigned char *)docRtfShapePropertyWords[i]
				 .rcwWord;
		...
		if (idx != i) {
			...
			LSLLDEB(i, docRtfShapePropertyWords[i].rcwWord, idx,
				hash);
			rval = -1;
		}
	}
...
const RtfControlWord *docRtfFindShapePropertyWord(const char *controlWord)
{
	...
	if (checked > 0) {
		...
		keyStringCount = sizeof(docRtfShapePropertyWords) /
					 sizeof(RtfControlWord) -
				 1;
