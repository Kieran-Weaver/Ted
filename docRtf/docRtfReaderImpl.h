...
const RtfControlWord *docRtfFindShapePropertyWord(const char *controlWord);

int docRtfFindControl(RtfReader *rr, int *pC, char *controlWord, int *pGotArg,
		      int *pArg);
...
int docRtfRevisionTable(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfRememberProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfBrdrProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfRememberCellInstanceProperty(const RtfControlWord *rcw, int arg,
				       RtfReader *rr);
...
int docRtfApplyControlWord(const RtfControlWord *rcw, int gotArg, int arg,
			   RtfReader *rr);
...
int docRtfReadGroupX(const RtfControlWord *rcw,
		     const RtfControlWord *applyFirst, int gotArg, int arg,
		     RtfReader *rr, const RtfControlWord *groupWords,
		     RtfAddTextParticule addParticule,
		     RtfCommitGroup commitGroup);
...
int docRtfConsumeGroup(const RtfControlWord *applyFirst, int gotArg, int arg,
		       RtfReader *rr, const RtfControlWord *groupWords,
		       RtfAddTextParticule addParticule);

int docRtfReadPict(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfReadShpXPict(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfReadObject(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfReadDrawingObject(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfReadTextField(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfReadFootnote(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfTextSpecialToField(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfListOverrideTable(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfRememberTabStopProperty(const RtfControlWord *rcw, int arg,
				  RtfReader *rr);

int docRtfFontProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfObjectProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfPictureProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfTextSpecialChar(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfTextBidiMark(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfReadDocumentTree(const RtfControlWord *rcw, DocumentTree *dt,
			   int *pExtItKind, RtfReader *rr, int ignoreEmpty,
			   const SelectionScope *ss);

int docRtfShapeProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);
int docRtfShapePropertyName(const RtfControlWord *rcw, int arg, RtfReader *rr);
int docRtfShapePropertyValue(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfReadRowProperties(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfColorIgnored(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfCommitDocPropText(const RtfControlWord *rcw, RtfReader *rr);

int docRtfDocTimeGroup(const RtfControlWord *rcw, int arg, RtfReader *rr);

void docRtfRefreshTextShading(RtfReader *rr, RtfReadingState *rrs);

int docRtfRefreshParagraphProperties(BufferDocument *bd, RtfReadingState *rrs);

int docRtfSetParaProperties(ParagraphProperties *pp, BufferDocument *bd,
			    int mindTable, RtfReadingState *rrs,
			    int breakOverride);

int docRtfAdaptToParaProperties(struct BufferItem *paraNode, BufferDocument *bd,
				RtfReadingState *rrs, int breakOverride);
...
int docRtfReadPnseclvl(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfApplyRawBytesGroup(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfReadTimeField(const RtfControlWord *rcw, int arg, RtfReader *rr);
...
int docRtfReadMapFont(const RtfReader *rr, int *pDocFontNum, int *pCharset,
		      int fileFontNum);
...
int docRtfEditRangeProperty(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfSelectionOpen(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfStoreStyleProperties(RtfReader *rr);

int docRtfRememberList(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfRememberListLevel(const RtfControlWord *rcw, int arg, RtfReader *rr);

int docRtfCommitListLevelText(const RtfControlWord *rcw, RtfReader *rr);
int docRtfCommitListLevelNumbers(const RtfControlWord *rcw, RtfReader *rr);
