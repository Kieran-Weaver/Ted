	       ...
	       int twipsSize, int vswap, const AfmFontInfo *afi)
{
	if (vswap) {
		...
		drBBox->drY1 =
			(twipsSize * -afi->afiFontBBox.drY0 - 500) / 1000;
		drBBox->drY0 =
			(twipsSize * -afi->afiFontBBox.drY1 - 500) / 1000;
		       ...
		       const AfmFontInfo *afi)
{
	...
	*pSuperBaseline =
		baseline - (fontSizeTwips * (fAsc - sAsc) + 500) / 1000;
		     ...
		     const AfmFontInfo *afi)
{
	...
	*pSubBaseline =
		baseline + (fontSizeTwips * (sDesc - fDesc) + 500) / 1000;
