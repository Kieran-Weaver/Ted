...
typedef struct PpdKeyword {
	...
	int (*pkConsumer)(SimpleInputStream *sisPpd, int valPos, char *input,
			  Ppd *ppd);
} PpdKeyword;

static int psPpdConsumeStatements(SimpleInputStream *sisPpd, char *input,
				  Ppd *ppd, PpdKeyword *pk, int keywordCount);
...
int psReadPpdFile(Ppd *ppd, const char *filename)
{
	int rval = 0;
...
static char *psGetInputLine(char *s, int *pLen, int size,
...
static int psPpdCollectValue(char **pValue, SimpleInputStream *sisPpd,
			     int valPos, char *input)
{
	char *s = input + valPos;
	char *value;
...
static int psPpdSaveString(char **pTarget, SimpleInputStream *sisPpd,
			   int valPos, char *input)
{
...
static int psPpdAdobe(SimpleInputStream *sisPpd, int valPos, char *input,
		      Ppd *ppd)
{
	return psPpdSaveString(&(ppd->ppdAdobe), sisPpd, valPos, input);
}

static int psPpdModelName(SimpleInputStream *sisPpd, int valPos, char *input,
			  Ppd *ppd)
{
	return psPpdSaveString(&(ppd->ppdModelName), sisPpd, valPos, input);
}

static int psPpdShortNickName(SimpleInputStream *sisPpd, int valPos,
			      char *input, Ppd *ppd)
{
	return psPpdSaveString(&(ppd->ppdShortNickName), sisPpd, valPos, input);
}

static int psPpdNickName(SimpleInputStream *sisPpd, int valPos, char *input,
			 Ppd *ppd)
{
	return psPpdSaveString(&(ppd->ppdNickName), sisPpd, valPos, input);
}

static int psPpdProduct(SimpleInputStream *sisPpd, int valPos, char *input,
			Ppd *ppd)
{
	return psPpdSaveString(&(ppd->ppdProduct), sisPpd, valPos, input);
}

static int psPpdManufacturer(SimpleInputStream *sisPpd, int valPos, char *input,
			     Ppd *ppd)
{
	return psPpdSaveString(&(ppd->ppdManufacturer), sisPpd, valPos, input);
}

static int psPpdPSVersion(SimpleInputStream *sisPpd, int valPos, char *input,
			  Ppd *ppd)
{
...
static int psPpdIgnore(SimpleInputStream *sisPpd, int valPos, char *input,
		       Ppd *ppd)
{
	return 0;
}
