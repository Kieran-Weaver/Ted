...
static const char DocSvgSvgTail[] = "  </svg>\n";
...
int svgStartDocument(SvgWriter *sw)
{
	...
	sioOutPrintf(sw->swXmlWriter.xwSos, DocSvgSvgHead, sw->swWide,
		     sw->swUnit, sw->swHigh, sw->swUnit, sw->swViewBox.drX0,
		     sw->swViewBox.drY0,
...
void svgWriteRectangleAttributes(SvgWriter *sw, const DocumentRectangle *dr)
{
...
void svgWriteViewBoxAttribute(SvgWriter *sw, const char *name,
...
static const char PsSvgF_Head[] = " patternUnits=\"userSpaceOnUse\""
				  " width=\"160\""
				  " height=\"160\""
				  " viewBox=\"0 0 8 8\""
				  ">";
...
static const char **PsSvgF_Patterns[] = {
	(const char **)0, PsSvgF_Horiz,	  PsSvgF_Vert,	  PsSvgF_Fdiag,
	PsSvgF_Bdiag,	  PsSvgF_Cross,	  PsSvgF_Dcross,  PsSvgF_DkHoriz,
	PsSvgF_DkVert,	  PsSvgF_DkFdiag, PsSvgF_DkBdiag, PsSvgF_DkCross,
	PsSvgF_DkDcross,
};

int svgDefineShading(SvgWriter *sw, int pattern, int shading,
