...
typedef SimpleOutputStream *(*HtmlOpenImageStream)(
	struct HtmlWritingContext *hwc, int n, const InsertedObject *io,
	const char *mimeT, const char *ext);

typedef int (*HtmlGetImageSrc)(MemoryBuffer *target,
			       struct HtmlWritingContext *hwc, int n,
...
extern void docHtmlPutString(const char *s, HtmlWritingContext *hwc);

extern void docHtmlNewLine(HtmlWritingContext *hwc);

extern int docHtmlSaveImgElement(int *pDone, HtmlWritingContext *hwc, int n,
				 const struct BufferItem *paraBi,
				 InsertedObject *io);

extern int docHtmlSaveImages(HtmlWritingContext *hwc);

extern void docHtmlChangeAttributes(HtmlWritingContext *hwc, int taNr);

extern void docHtmlWriteStringAttribute(HtmlWritingContext *hwc,
					const char *name, const char *value);

extern void docHtmlWriteIntAttribute(HtmlWritingContext *hwc, const char *name,
				     int value);

extern void docHtmlEscapeCharacters(HtmlWritingContext *hwc, const char *ss,
				    int len);

extern int docHtmlStartField(const DocumentField *df, HtmlWritingContext *hwc,
			     const struct BufferItem *bi, int attNr);

extern int docHtmlFinishField(const DocumentField *df, HtmlWritingContext *hwc);
...
extern int docHtmlSaveSelection(HtmlWritingContext *hwc, DocumentTree *dt,
				const DocumentSelection *ds);

extern void docHtmlEmitBackgroundProperty(const ItemShading *is,
...
extern int docHtmlObjectSaveHow(int *pType, const char **pMimeType,
				const char **pExt,
...
extern int docHtmlStartNote(const DocumentField *df, HtmlWritingContext *hwc,
			    const struct BufferItem *bi, int attNr);

extern int docHtmlStartAnchor(HtmlWritingContext *hwc, int isNote,
