...
static int bmWbmpGetNumber(unsigned int *pNum, SimpleInputStream *sis)
{
	unsigned int num = 0;
...
static int bmWbmpReadWbmp(BitmapDescription *bd, unsigned char **pBuffer,
...
int bmReadWbmpFile(const MemoryBuffer *filename, unsigned char **pBuffer,
...
int bmCanWriteWbmpFile(const BitmapDescription *bd, int privateFormat)
{
...
static int bmWbmpPutNumber(int num, SimpleOutputStream *sos)
{
...
int bmWriteWbmpFile(const MemoryBuffer *filename, const unsigned char *buffer,
