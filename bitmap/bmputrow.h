...
typedef int (*PutScreenRow)(unsigned char *to, const FillJob *fj,
			    ColorValue *val);
...
extern int bmGetPutRow(PutScreenRow *pPutRow, int *pScratchSize,
...
extern int bmSetFillJob(FillJob *fj, ColorAllocator *ca, int frWide, int toWide,
