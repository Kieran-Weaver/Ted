...
static int bmToThresholdAllocateColor(AllocatorColor *ac, ColorAllocator *ca,
...
static void bmThresholdFillHistogram8(ThresholderHistogram *th,
...
int bmThreshold(RasterImage *riOut, const RasterImage *riIn, int ignoredInt)
{
