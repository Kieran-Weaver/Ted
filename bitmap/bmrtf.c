...
static int bmRtfStartRtf(const BitmapDescription *bd, const char *type,
...
static int bmRtfImageSize(const BitmapDescription *bd, SimpleOutputStream *sos)
{
	int picwgoal;
	int pichgoal;
	int picw;
...
int bmRtfWritePngRtf(const BitmapDescription *bd, const unsigned char *buffer,
		     SimpleOutputStream *sos)
{
	int rval = 0;
...
int bmRtfWriteJfifRtf(const BitmapDescription *bd, const unsigned char *buffer,
		      SimpleOutputStream *sos)
{
	int rval = 0;
	SimpleOutputStream *sosHex = (SimpleOutputStream *)0;
...
int bmRtfWriteRtf(const BitmapDescription *bd, const unsigned char *buffer,
		  SimpleOutputStream *sos)
{
...
int bmCanWriteRtfFile(const BitmapDescription *bd, int privateFormat)
{
...
int bmWriteRtfFile(const MemoryBuffer *filename, const unsigned char *buffer,
