...
int tedFindPosition(DocumentPosition *dp, PositionGeometry *pg,
...
void tedSetObjectWindows(struct EditDocument *ed,
				const PositionGeometry *pg,
				const InsertedObject *io,
				const LayoutContext *lc);
...
void tedDocAdaptTopRuler(struct EditDocument *ed,
				const DocumentSelection *ds,
