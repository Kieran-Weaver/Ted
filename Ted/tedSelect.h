...
extern void tedSetSelectionLow(struct EditDocument *ed,
			       const DocumentSelection *dsSet, int lastLine,
...
extern int tedGetObjectSelection(const struct EditDocument *ed, int *pPartObj,
...
extern int tedGetSelection(DocumentSelection *ds, SelectionGeometry *sg,
...
extern int tedFindRootForPosition(DocumentPosition *dpFound,
				  ...
				  DocumentTree **pTree,
				  struct BufferItem **pSelSectBi, int *pPage,
				  int *pColumn, struct EditDocument *ed,
				  int docX, int docY);
...
extern void tedSetSelectedPosition(struct EditDocument *ed,
				   const DocumentPosition *dp, int lastLine,
				   int *pScrolledX, int *pScrolledY);
