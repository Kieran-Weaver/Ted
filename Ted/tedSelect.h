...
void tedSetSelectionLow(struct EditDocument *ed,
...
void tedExposeSelection(struct EditDocument *ed,
...
void tedSetSelection(struct EditDocument *ed,
			    const DocumentSelection *dsSet, int lastLine,
			    int *pScrolledX, int *pScrolledY);

void tedSetSelectedPosition(struct EditDocument *ed,
