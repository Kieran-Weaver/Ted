...
int tedReplaceSelectionWithRasterImage(struct EditDocument *ed,
...
int tedObjectSetImagePropertiesImpl(TedEditOperation *teo,
					   InsertedObject *io,
...
int tedEditShiftRowsInTable(struct EditDocument *ed, int direction,
				   int traced);
...
int tedDocDeleteSelection(struct EditDocument *ed, int command,
				 int traced);
...
int tedInsertTable(struct EditDocument *ed, int rows, int columns,
			  int traced);
...
int tedEditStartTypedStep(TedEditOperation *teo, int command,
				 int fieldKind);

int tedFinishEditOperation(TedEditOperation *teo);

void tedDocInsertStringWithAttribute(struct EditDocument *ed,
...
int tedIncludePlainDocument(struct EditDocument *ed,
				   BufferDocument *bdFrom, int traced);

int tedIncludeRtfDocument(struct EditDocument *ed,
				 BufferDocument *bdFrom, int traced);
