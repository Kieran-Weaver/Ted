...
static AppConfigurableResource TEDApplicationResourceTable[] = {
	...
	/********************************************************************/
	APP_RESOURCE("fileFileNotRtf", offsetof(TedAppResources, tarFileNotRtf),
	...
	APP_RESOURCE("appFileMenuText",
		     offsetof(TedAppResources, tarAppFileMenuText), "File"),
	APP_RESOURCE("appWinMenuText",
		     offsetof(TedAppResources, tarAppWinMenuText), "Window"),
	...
	APP_RESOURCE("docFileMenuText",
		     offsetof(TedAppResources, tarDocFileMenuText), "File"),
	APP_RESOURCE("docEditMenuText",
		     offsetof(TedAppResources, tarDocEditMenuText), "Edit"),
	APP_RESOURCE("docInsertMenuText",
		     offsetof(TedAppResources, tarDocInsertMenuText), "Insert"),
	APP_RESOURCE("docWinMenuText",
		     offsetof(TedAppResources, tarDocWinMenuText), "Window"),
	APP_RESOURCE("docFontMenuText",
		     offsetof(TedAppResources, tarDocFontMenuText), "Font"),
	APP_RESOURCE("docFormatMenuText",
		     offsetof(TedAppResources, tarDocFormatMenuText), "Format"),
	APP_RESOURCE("docTableMenuText",
		     offsetof(TedAppResources, tarDocTableMenuText), "Table"),
	APP_RESOURCE("docToolsMenuText",
		     offsetof(TedAppResources, tarDocToolMenuText), "Tools"),
	APP_RESOURCE("helpMenuText", offsetof(TedAppResources, tarHelpMenuText),
		     "Help"),
...
/**/
	...
	APP_RESOURCE("showTableGrid",
		     offsetof(TedAppResources, tarShowTableGridString), "1"),

	/**/
	APP_RESOURCE("autoHyphenate",
		     offsetof(TedAppResources, tarAutoHyphenateString), "0"),
	...
	/**/
	APP_RESOURCE("pageGapMM", offsetof(TedAppResources, tarPageGapMMString),
		     (char *)0),
	/**/
	APP_RESOURCE("lenientRtf",
		     offsetof(TedAppResources, tarLenientRtfString), "0"),
	APP_RESOURCE("traceEdits",
		     offsetof(TedAppResources, tarTraceEditsString), "1"),
	APP_RESOURCE("pdfOutline",
		     offsetof(TedAppResources, tarPdfOutlineString), "1"),
...
#define TEDmiDocFileSaveAs 3
	{
		"docFileMenuSaveAsText",
		"Save As ...",
		"docFileMenuSaveAsKey",
		(char *)0,
		"docFileMenuSaveAsKeyText",
		(char *)0,
		ITEMtyOPTION,
		appDocFileSaveAs,
	},
#define TEDmiDocFilePrint 4
	{
		"docFileMenuPrintText",
		"Print ...",
		"docFileMenuPrintKey",
		"Ctrl <Key>p",
		"docFileMenuPrintKeyText",
		"^P",
		ITEMtyOPTION,
		tedDocFilePrint,
	},
#define TEDmiDocFileProperties 5
	{
		"docFileMenuPropsText",
		"Properties ...",
		"docFileMenuPropsKey",
		(char *)0,
		"docFileMenuPropsKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFileProps,
	},
#define TEDmiDocFileUnlock 6
	{
		"docFileMenuUnlockText",
		"Unlock",
		"docFileMenuUnlockKey",
		(char *)0,
		"docFileMenuUnlockKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFileUnlock,
	},
#define TEDmiDocFileRecover 7
	{
		"docFileMenuRecoverText",
		"Recover",
		"docFileMenuRecoverKey",
		(char *)0,
		"docFileMenuRecoverKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFileRecover,
	},
#define TEDmiDocFileClose 8
	{
		"docFileMenuCloseText",
		"Close",
		"docFileMenuCloseKey",
		(char *)0,
		"docFileMenuCloseKeyText",
		(char *)0,
		ITEMtyOPTION,
		appDocFileClose,
	},
...
#define TEDmiDocEditRepeat 1
	{
		"docEditMenuRepeatText",
		"Repeat",
		"docEditMenuRepeatKey",
		"Ctrl <Key>y",
		"docEditMenuRepeatKeyText",
		"^Y",
		ITEMtyOPTION,
		tedDocEditRepeat,
	},
...
#define TEDmiDocEditPaste 4
	{
		"docEditMenuPasteText",
		"Paste",
		"docEditMenuPasteKey",
		"Ctrl <Key>v",
		"docEditMenuPasteKeyText",
		"^V",
		ITEMtyOPTION,
		tedDocEditPaste,
	},
#define TEDmiDocEditSelectAll 5
	{
		"docEditMenuSelAllText",
		"Select All",
		"docEditMenuSelAllKey",
		"Ctrl <Key>a",
		"docEditMenuSelAllKeyText",
		"^A",
		ITEMtyOPTION,
		appDocEditSelAll,
	},
...
#define TEDmiDocEditFindNext 8
	{
		"docToolMenuFindNextText",
		"Find Next",
		"docToolMenuFindNextKey",
		"<Key>F3",
		"docToolMenuFindNextKeyText",
		"F3",
		ITEMtyOPTION,
		tedDocToolFindNext,
	},
...
#define TEDmiDocInsertInsPict 0
	{
		"docInsertMenuInsPictText",
		"Image ...",
		"docInsertMenuInsPictKey",
		(char *)0,
		"docInsertMenuInsPictKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertImage,
	},
#define TEDmiDocInsertInsSymbol 1
	{
		"docInsertMenuInsertSymbolText",
		"Symbol",
		"docInsertMenuInsertSymbolKey",
		(char *)0,
		"docInsertMenuInsertSymbolKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocToolInsertSymbol,
	},
#define TEDmiDocInsertInsHyperlink 2
	{
		"docInsertMenuHyperlinkText",
		"Hyperlink",
		"docInsertMenuHyperlinkKey",
		"Ctrl <Key>k",
		"docInsertMenuHyperlinkKeyText",
		"^K",
		ITEMtyOPTION,
		tedDocInsertLink,
	},
#define TEDmiDocInsertInsBookmark 3
	{
		"docInsertMenuBookmarkText",
		"Bookmark",
		"docInsertMenuBookmarkKey",
		(char *)0,
		"docInsertMenuBookmarkKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertBookmark,
	},
#define TEDmiDocInsertInsFootnote 4
	{
		"docInsertMenuFootnoteText",
		"Footnote",
		"docInsertMenuFootnoteKey",
		(char *)0,
		"docInsertMenuFootnoteKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertFootnote,
	},
#define TEDmiDocInsertInsEndnote 5
	{
		"docInsertMenuEndnoteText",
		"Endnote",
		"docInsertMenuEndnoteKey",
		(char *)0,
		"docInsertMenuEndnoteKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertEndnote,
	},
#define TEDmiDocInsertInsChftnsep 6
	{
		"docInsertMenuChftnsepText",
		"Footnote Separator",
		"docInsertMenuChftnsepKey",
		(char *)0,
		"docInsertMenuChftnsepKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertChftnsep,
	},
#define TEDmiDocInsertInsFile 7
	{
		"docInsertMenuInsertFileText",
		"File ...",
		"docInsertMenuInsertFileKey",
		(char *)0,
		"docInsertMenuInsertFileKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertFile,
	},
#define TEDmiDocInsertInsTable 8
	{
		"docInsertMenuInsertTableText",
		"Table",
		"docInsertMenuInsertTableKey",
		(char *)0,
		"docInsertMenuInsertTableKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableInsertTable,
	},
#define TEDmiDocInsertInsPageNumber 9
	{
		"docInsertMenuInsertPageNumberText",
		"Page Number",
		"docInsertMenuInsertPageNumberKey",
		(char *)0,
		"docInsertMenuInsertPageNumberKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertPageNumber,
	},
...
#define TEDmiDocInsertInsLineBreak 11
	{
		"docInsertMenuInsertLineBreakText",
		"Line Break",
		"docInsertMenuInsertLineBreakKey",
		(char *)0,
		"docInsertMenuInsertLineBreakKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertLineBreak,
	},
#define TEDmiDocInsertInsPageBreak 12
	{
		"docInsertMenuInsertPageBreakText",
		"Page Break",
		"docInsertMenuInsertPageBreakKey",
		(char *)0,
		"docInsertMenuInsertPageBreakKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertPageBreak,
	},
#define TEDmiDocInsertInsColumnBreak 13
	{
		"docInsertMenuInsertColumnBreakText",
		"Column Break",
		"docInsertMenuInsertColumnBreakKey",
		(char *)0,
		"docInsertMenuInsertColumnBreakKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocInsertColumnBreak,
	},
#define TEDmiDocInsertInsSectBreak 14
	{
		"docInsertMenuInsertSectBreakText",
		"Section Break",
		"docInsertMenuInsertSectBreakKey",
		(char *)0,
		"docInsertMenuInsertSectBreakKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocMenuInsertSectBreak,
	},
...
#define TEDmiDocFontItalic 1
	{
		"docFontMenuItalicText",
		"Italic",
		"docFontMenuItalicKey",
		"Ctrl <Key>i",
		"docFontMenuItalicKeyText",
		"^I",
		ITEMtyTOGGLE_OFF,
		tedDocFontItalic,
	},
#define TEDmiDocFontUnderlined 2
	{
		"docFontMenuUnderlText",
		"Underlined",
		"docFontMenuUnderlKey",
		"Ctrl <Key>u",
		"docFontMenuUnderlKeyText",
		"^U",
		ITEMtyTOGGLE_OFF,
		tedDocFontUnderlined,
	},
#define TEDmiDocFontSuperscript 3
	{
		"docFontMenuSuperscriptText",
		"Superscript",
		"docFontMenuSuperscriptKey",
		(char *)0,
		"docFontMenuSuperscriptKeyText",
		(char *)0,
		ITEMtyTOGGLE_OFF,
		tedDocFontSupersub,
	},
#define TEDmiDocFontSubscript 4
	{
		"docFontMenuSubscriptText",
		"Subscript",
		"docFontMenuSubscriptKey",
		(char *)0,
		"docFontMenuSubscriptKeyText",
		(char *)0,
		ITEMtyTOGGLE_OFF,
		tedDocFontSupersub,
	},
...
#define TEDmiDocFontPaste 7
	{
		"docFontMenuPasteText",
		"Paste Font",
		"docFontMenuPasteKey",
		(char *)0,
		"docFontMenuPasteKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFontPaste,
	},
...
#define TEDmiDocTableInsertTable 0
	{
		"docTableInsertTableText",
		"Insert Table",
		"docTableInsertTableKey",
		(char *)0,
		"docTableInsertTableKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableInsertTable,
	},
...
#define TEDmiDocTableAddColumn 2
	{
		"docTableAddColumnText",
		"Add Column",
		"docTableAddColumnKey",
		(char *)0,
		"docTableAddColumnKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableAddColumn,
	},
...
#define TEDmiDocTableSelectTable 4
	{
		"docTableSelectTableText",
		"Select Table",
		"docTableSelectTableKey",
		(char *)0,
		"docTableSelectTableKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableSelectTable,
	},
#define TEDmiDocTableSelectRow 5
	{
		"docTableSelectRowText",
		"Select Row",
		"docTableSelectRowKey",
		(char *)0,
		"docTableSelectRowKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableSelectRow,
	},
#define TEDmiDocTableSelectColumn 6
	{
		"docTableSelectColumnText",
		"Select Column",
		"docTableSelectColumnKey",
		(char *)0,
		"docTableSelectColumnKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableSelectColumn,
	},
...
#define TEDmiDocTableDeleteTable 8
	{
		"docTableDeleteTableText",
		"Delete Table",
		"docTableDeleteTableKey",
		(char *)0,
		"docTableDeleteTableKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableDeleteTable,
	},
#define TEDmiDocTableDeleteRow 9
	{
		"docTableDeleteRowText",
		"Delete Row",
		"docTableDeleteRowKey",
		(char *)0,
		"docTableDeleteRowKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableDeleteRow,
	},
#define TEDmiDocTableDeleteColumn 10
	{
		"docTableDeleteColumnText",
		"Delete Column",
		"docTableDeleteColumnKey",
		(char *)0,
		"docTableDeleteColumnKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocTableDeleteColumn,
	},
...
#define TEDmiDocTableDrawGrid 12
	{
		"docTableDrawGridText",
		"Draw Table Grid",
		"docTableDrawGridKey",
		(char *)0,
		"docTableDrawGridKeyText",
		(char *)0,
		ITEMtyTOGGLE_ON,
		tedDocTableDrawGrid,
	},
...
#define TEDmiDocFormatOnePara 0
	{
		"docFormatMenuOneParaText",
		"Make One Paragraph",
		"docFormatMenuOneParaKey",
		(char *)0,
		"docFormatMenuOneParaKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFormatOnePara,
	},
...
#define TEDmiDocFormatOneParaSep 1
	...
	/*  2  */
	{
		"docFormatMenuCopyRulText",
		"Copy Ruler",
		"docFormatMenuCopyRulKey",
		(char *)0,
		"docFormatMenuCopyRulKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFormatCopyRul,
	},
...
#define TEDmiDocFormatPasteRuler 3
	{
		"docFormatMenuPasteRulText",
		"Paste Ruler",
		"docFormatMenuPasteRulKey",
		(char *)0,
		"docFormatMenuPasteRulKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFormatPasteRul,
	},

#define TEDmiDocFormatIncIndent 4
	{
		"docFormatMenuIncreaseIndentText",
		"Increase Indent",
		"docFormatMenuIncreaseIndentKey",
		(char *)0,
		"docFormatMenuIncreaseIndentKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFormatIncreaseIndent,
	},

#define TEDmiDocFormatDecIndent 5
	{
		"docFormatMenuDecreaseIndentText",
		"Decrease Indent",
		"docFormatMenuDecreaseIndentKey",
		(char *)0,
		"docFormatMenuDecreaseIndentKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFormatDecreaseIndent,
	},
...
#define TEDmiDocFormatAlignLeft 7
	{
		"docFormatMenuAlignLeftText",
		"Align Left",
		"docFormatMenuAlignLeftKey",
		"Ctrl <Key>l",
		"docFormatMenuAlignLeftKeyText",
		"^L",
		ITEMtyOPTION,
		tedDocFormatAlignLeft,
	},

#define TEDmiDocFormatAlignRight 8
	{
		"docFormatMenuAlignRightText",
		"Align Right",
		"docFormatMenuAlignRightKey",
		"Ctrl <Key>r",
		"docFormatMenuAlignRightKeyText",
		"^R",
		ITEMtyOPTION,
		tedDocFormatAlignRight,
	},

#define TEDmiDocFormatAlignCenter 9
	{
		"docFormatMenuAlignCenterText",
		"Center Text",
		"docFormatMenuAlignCenterKey",
		"Ctrl <Key>e",
		"docFormatMenuAlignCenterKeyText",
		"^E",
		ITEMtyOPTION,
		tedDocFormatAlignCenter,
	},

#define TEDmiDocFormatAlignJustify 10
	{
		"docFormatMenuAlignJustifyText",
		"Justify Text",
		"docFormatMenuAlignJustifyKey",
		"Ctrl <Key>j",
		"docFormatMenuAlignJustifyKeyText",
		"^J",
		ITEMtyOPTION,
		tedDocFormatAlignJustify,
	},
...
#define TEDmiDocFormatTool 12
	{
		"docToolMenuFormatText",
		"Format Tool",
		"docToolMenuFormatKey",
		(char *)0,
		"docToolMenuFormatKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocFormatTool,
	}
...
#define TEDmiDocToolsSpelling 2
	{
		"docToolMenuSpellText",
		"Spelling",
		"docToolMenuSpellKey",
		"<Key>F7",
		"docToolMenuSpellKeyText",
		"F7",
		ITEMtyOPTION,
		tedDocToolSpell,
	},
#define TEDmiDocToolsPageLayout 3
	{
		"docToolMenuPageLayoutText",
		"Page Layout",
		"docToolMenuPageLayoutKey",
		(char *)0,
		"docToolMenuPageLayoutKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocShowPageTool,
	},
#define TEDmiDocToolsInsertSymbol 4
	{
		"docToolMenuInsertSymbolText",
		"Insert Symbol",
		"docToolMenuInsertSymbolKey",
		(char *)0,
		"docToolMenuInsertSymbolKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocToolInsertSymbol,
	},
...
static AppMenuItem TED_DocHelpMenuItems[] = {
	{
		...
		"docWinMenuAboutKey",
		(char *)0,
		"docWinMenuAboutKeyText",
		(char *)0,
		ITEMtyOPTION,
		appDocAbout,
	},
	{
		"docHelpMenuDocumentText",
		"Document",
		"docHelpMenuDocumentKey",
		(char *)0,
		"docHelpMenuDocumentKeyText",
		(char *)0,
		ITEMtyOPTION,
		tedDocManual,
	},
...
static void tedMakePrivateDocumentMenus(EditApplication *ea, EditDocument *ed,
					APP_WIDGET menubar)
{
	...
	td->tdCutOption = TED_DocEditMenuItems[TEDmiDocEditCut].amiOptionWidget;
	td->tdPasteOption =
		TED_DocEditMenuItems[TEDmiDocEditPaste].amiOptionWidget;

	td->tdInsertMenu = appMakeMenu(
		&(td->tdInsertMenuButton), &(ed->edToplevel), ea, menubar,
		TEDResources.tarDocInsertMenuText, 0, TED_DocInsertMenuItems,
	...
	td->tdInsHyperlinkOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsHyperlink]
			.amiOptionWidget;
	td->tdInsBookmarkOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsBookmark]
			.amiOptionWidget;
	td->tdInsInsertFootnoteOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsFootnote]
			.amiOptionWidget;
	td->tdInsInsertEndnoteOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsEndnote].amiOptionWidget;
	td->tdInsInsertChftnsepOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsChftnsep]
			.amiOptionWidget;
	td->tdInsInsertTableOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsTable].amiOptionWidget;
	td->tdInsInsertPageNumberOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsPageNumber]
			.amiOptionWidget;
	td->tdInsInsertLineBreakOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsLineBreak]
			.amiOptionWidget;
	td->tdInsInsertPageBreakOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsPageBreak]
			.amiOptionWidget;
	td->tdInsInsertColumnBreakOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsColumnBreak]
			.amiOptionWidget;
	td->tdInsInsertSectBreakOption =
		TED_DocInsertMenuItems[TEDmiDocInsertInsSectBreak]
			.amiOptionWidget;

	td->tdFontMenu = appMakeMenu(
		&(td->tdFontMenuButton), &(ed->edToplevel), ea, menubar,
		TEDResources.tarDocFontMenuText, 0, TED_DocFontMenuItems,
		sizeof(TED_DocFontMenuItems) / sizeof(AppMenuItem), (void *)ed);
	...
	td->tdFontToggleSeparator =
		TED_DocFontMenuItems[TEDmiDocFontToggleSeparator]
			.amiOptionWidget;
	td->tdFontPasteOption =
		TED_DocFontMenuItems[TEDmiDocFontPaste].amiOptionWidget;

	td->tdTableMenu = appMakeMenu(
		&(td->tdTableMenuButton), &(ed->edToplevel), ea, menubar,
		TEDResources.tarDocTableMenuText, 0, TED_DocTableMenuItems,
	...
	td->tdTabInsertSeparator =
		TED_DocTableMenuItems[TEDmiDocTableInsertSeparator]
			.amiOptionWidget;
	...
	td->tdTabSelectSeparator =
		TED_DocTableMenuItems[TEDmiDocTableSelectSeparator]
			.amiOptionWidget;
	...
	td->tdTabDeleteSeparator =
		TED_DocTableMenuItems[TEDmiDocTableDeleteSeparator]
			.amiOptionWidget;

	td->tdDrawTableGridOption =
		TED_DocTableMenuItems[TEDmiDocTableDrawGrid].amiOptionWidget;

	td->tdFormatMenu = appMakeMenu(
		&(td->tdFormatMenuButton), &(ed->edToplevel), ea, menubar,
		TEDResources.tarDocFormatMenuText, 0, TED_DocFormatMenuItems,
	...
	td->tdFormatAlignCenterOption =
		TED_DocFormatMenuItems[TEDmiDocFormatAlignCenter]
			.amiOptionWidget;
	td->tdFormatAlignJustifyOption =
		TED_DocFormatMenuItems[TEDmiDocFormatAlignJustify]
			.amiOptionWidget;
	td->tdFormatAlignSeparator =
		TED_DocFormatMenuItems[TEDmiDocFormatAlignSep].amiOptionWidget;

	td->tdToolsMenu = appMakeMenu(
		&(td->tdToolsMenuButton), &(ed->edToplevel), ea, menubar,
		TEDResources.tarDocToolMenuText, 0, TED_DocToolMenuItems,
		sizeof(TED_DocToolMenuItems) / sizeof(AppMenuItem), (void *)ed);
...
static AppSelectionTargetType TedClipboardTargets[] = {
	...
	{ "STRING", (APP_ATOM)0, tedPasteClipboardString,
	  tedCopyClipboardString },
	{ "image/png", (APP_ATOM)0, tedPasteClipboardPng, tedCopyClipboardPng },
...
AppSelectionTargetType TedPrimaryTargets[] = {
	...
	{ "STRING", (APP_ATOM)0, tedPastePrimaryString, tedCopyPrimaryString },
};
...
AppSelectionTargetType TedRulerTargets[] = {
	{ "application/rtf", (APP_ATOM)0, tedPasteRulerTed, tedCopyRulerTed },
};
...
AppSelectionTargetType TedFontTargets[] = {
	{ "application/rtf", (APP_ATOM)0, tedPasteFontTed, tedCopyFontTed },
};
...
static AppSelectionType TedDocSelectionTypes[] = {
	{ "CLIPBOARD", (APP_ATOM)0, TedClipboardTargets,
	...
	{ "PRIMARY", (APP_ATOM)0, TedPrimaryTargets,
	  sizeof(TedPrimaryTargets) / sizeof(AppSelectionTargetType),
	  tedPrimaryLost },
};
...
#define FT2_VSS "FT2 " VSSS(FREETYPE_MAJOR) "." VSSS(FREETYPE_MINOR) " "

#define XFT_VSS \
	"XFT " VSSS(XFT_MAJOR) "." VSSS(XFT_MINOR) "." VSSS(XFT_REVISION) " "

#define FC_VSS                                                    \
	"FONTCONFIG " VSSS(FC_MAJOR) "." VSSS(FC_MINOR) "." VSSS( \
		FC_REVISION) " "
...
static EditApplication TedApplication = {
	...
	/****************************************************/
	TedFileExtensions,
	sizeof(TedFileExtensions) / sizeof(AppFileExtension),
	/****************************************************/
...
int main(int argc, char *argv[])
{
	...
	if (RPprop_FULL_COUNT > PROPmaskMAXPROPS) {
		LLDEB(RPprop_FULL_COUNT, PROPmaskMAXPROPS);
		return 1;
	}
	if (PPprop_FULL_COUNT > PROPmaskMAXPROPS) {
		LLDEB(PPprop_FULL_COUNT, PROPmaskMAXPROPS);
		return 1;
	}
	if (CLprop_COUNT > PROPmaskMAXPROPS) {
		LLDEB(CLprop_COUNT, PROPmaskMAXPROPS);
		return 1;
	}
	if (DPprop_COUNT > PROPmaskMAXPROPS) {
		LLDEB(DPprop_COUNT, PROPmaskMAXPROPS);
		return 1;
	}
	if (TFPprop_FULL_COUNT > PROPmaskMAXPROPS) {
		LLDEB(TFPprop_FULL_COUNT, PROPmaskMAXPROPS);
		return 1;
	}
