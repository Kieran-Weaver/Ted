...
int tedAppDeleteCurrentFrame(EditApplication *ea)
{
	...
	return tedDocDeleteCurrentFrame(
		ed, ((TedDocument *)ed->edPrivateData)->tdTraced);
}
...
int tedAppDeleteSelectedParagraphs(EditApplication *ea)
{
	...
	return tedDocDeleteSelectedParagraphs(
		ed, ((TedDocument *)ed->edPrivateData)->tdTraced);
}
...
int tedAppDeleteSelectedSections(EditApplication *ea)
{
	...
	return tedDocDeleteSelectedSections(
		ed, ((TedDocument *)ed->edPrivateData)->tdTraced);
}
...
int tedAppInsertParagraph(EditApplication *ea, int after)
{
	...
	return tedDocInsertParagraph(
		ed, after, ((TedDocument *)ed->edPrivateData)->tdTraced);
}
				    ...
				    const ParagraphProperties *ppNew)
{
	...
	return tedDocChangeParagraphProperties(
		ed, ppSetMask, ppNew,
		((TedDocument *)ed->edPrivateData)->tdTraced);
}
				  ...
				  const SectionProperties *spNew)
{
	...
	return tedDocChangeSectionProperties(
		ed, spSetMask, spNew,
		((TedDocument *)ed->edPrivateData)->tdTraced);
}
				     ...
				     const DocumentProperties *dpSet)
{
	...
	return tedDocChangeAllSectionProperties(
		ed, spSetMask, spNew, dpSetMask, dpSet,
		((TedDocument *)ed->edPrivateData)->tdTraced);
}
...
int tedAppSetParagraphTabs(EditApplication *ea, const struct TabStopList *tsl)
{
	...
	return tedDocSetParagraphTabs(
		ed, tsl, ((TedDocument *)ed->edPrivateData)->tdTraced);
}
				...
				const DocumentProperties *dpSet)
{
	...
	return tedDocSetDocumentProperties(
		ed, dpSetMask, dpSet,
		((TedDocument *)ed->edPrivateData)->tdTraced);
}
			      ...
			      const RowProperties *rpSet)
{
	...
	tedDocSetTableProperties(ed, wholeRow, wholeColumn, cpSetMask, cpSet,
				 rpSetMask, rpSet,
				 ((TedDocument *)ed->edPrivateData)->tdTraced);
			    ...
			    const struct DocumentList *dlNew)
{
	...
	return tedDocChangeCurrentList(
		ed, dlNew, ((TedDocument *)ed->edPrivateData)->tdTraced);
}
