...
extern const OfficeCharset *utilGetOfficeCharsetByCharset(int *pIdx,
							  int charset);

extern const OfficeCharset *utilGetOfficeCharsetByIndex(int charsetIdx);

extern const OfficeCharset *utilGetOfficeCharsetBySuffix(int *pIdx,
							 const char *fontname);

extern int utilOfficeCharsetCodeForUnicode(int charsetIdx, int unicode);
